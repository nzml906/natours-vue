    ...
    <footer class="footer">
      ...
      <div class="row">
        ...
        <div class="col-1-of-2">
          ...
          >Lorem ipsum dolor, sit amet consectetur adipisicing elit. At temporibus doloribus, accusantium minima quisquam molestiae non quaerat blanditiis reiciendis, nemo explicabo obcaecati neque suscipit quibusdam! Eligendi, voluptas in iusto, quia, minus expedita consequatur sunt ducimus nisi sit ratione. Incidunt eius architecto fugiat sint, iure quos quam deserunt deleniti voluptas quaerat voluptatem repellendus. Beatae perspiciatis neque assumenda tempore officia voluptas blanditiis perferendis, a error eligendi? Culpa delectus, blanditiis dolorem vitae dignissimos ex, saepe dolores necessitatibus aspernatur, sit facilis voluptatibus quae enim.</p>
        </div>
      </div>
    </footer>
  </div>
